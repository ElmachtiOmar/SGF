...
namespace Infrastructure.Mogrations
{
    ...
    [Migration("20240608115928_AddingDate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Produit", b =>
                {
                    ...
                    b.Property<Guid?>("LigneFactureId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Entities.Produit", b =>
                {
                    b.HasOne("Core.Entities.LigneFacture", null)
                        .WithMany("Produit")
                        .HasForeignKey("LigneFactureId");
                });
